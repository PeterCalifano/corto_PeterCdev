...
def main():
    ...
    #NAVCAM # TODO (PC) load these parameters from yaml file!
    ...
    #### (3) DYNAMIC PARAMETERS #### # DEVNOTE (PC) these parameters may be left here as they are
    ...
    while receiving_flag:
        ...
        n_bodies = len(data)/7 - 2 #Number of bodies apart from CAM and SUN # FIXME Hardcoded number of bodies (assuming 2)
